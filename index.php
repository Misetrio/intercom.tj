...
<div class="container">
    ...
    <div class="divPanel page-content">
        ...
        <div class="row-fluid">
		    ...
		    <div class="lead">
                        <h2>Зона покрытия</h2>
                        <h3>г. Душанбе, р-н Рудаки, города Вахдат, Худжанд, Бустон и прилегающие к городам районы до 5-6 км.</h3>
			...
			<br><br>Для того ,чтобы подключиться просто оставьте заявку   <a href="#win2" class="button button-red">Здесь</a> в любое время , или позвоните по номеру 2217095,427800099 с 9 до 18 ч</h3>
                        ...
                        <div class="popup">
                            ...
                            <div>
                                <form class="contact_form" action="contact-form.php" method="post">
                                    ...
                                    <div>
                                       ...
                                       <input type="radio" value="домашнее беспроводное устройство" name="type"> домашнее беспроводное устройство 4 в 1 (WiFi,NGN,4 портовый свич ,4G) /
                                    ...
                                    <div>
                                        ...
                                        2+9 =   <input type="text" name="result" style="width: 100px;" placeholder="Результат"  />
                            ...
                            <p style="text-align: center;">
                                Заявки на беспроводное 4G подключение принимаются из г Душанбе,района Рудаки ,Вахдат В ближайшее время будут другие зоны покрытия
                            </p>

                            <a class="close" title="Закрыть" href="#close"></a>
                        </div>
                    </div>
			<div class="lead" style="width: 1100px !important; text-align: center;">
	<hr style="margin:45px 0 35px" />
        
          	<h2>Отзывы</h2>
            <center><video width="400" height="300" controls="controls" poster="images/reklama.jpg">
   <source src="video/intercom.ogv" type='video/ogg; codecs="theora, vorbis"'>
   Ваш браузер не поддерживает проигрывние видео. Установите браузер <a href="https://www.google.ru/intl/ru/chrome/?brand=CHBD&ds_kid=43700027443936350&gclid=Cj0KCQiAzrTUBRCnARIsAL0mqcwOYveX9r_5k-bAKGJ6ZQLYOwMYWIUwdU7-VL95EVjSHB_E3EUdYzsaArYoEALw_wcB&gclsrc=aw.ds&dclid=CKam-4HOuNkCFRKCGQodovgN7A" target="_blank" >Google Chrome</a>
или <a href="https://www.mozilla.org/ru/firefox/new/" target="_blank" >Mozilla FireFox</a> для просмотра этого видео.<br>
   <a href="http://77.244.146.133:8980/files/raznoe/Reklama.flv">Скачайте видео</a></center>
            <a style="color: "#3ca05b"; margin-top:0px;" href="http://www.speedtest.net/result/7057184168"><h3>ТЕСТ СОЕДИНЕНИЯ</h3></a>
            </div>
